...
class CategoryTypesFragment : BaseFragment() {
    ...
    private fun startRecyclerView() {
        product_recyclerView.apply {
            ...
            item_1.image =
                "https://app.berrika.com/admin/template/assets/images/products/2020-09-0817:22:45-13_Strawberries.png"
            item_2.name = "Orange"
            item_2.image =
                "https://i.pinimg.com/originals/12/4e/52/124e5280ba9b02ed3db753542a5fe68c.png"
            item_3.name = "Orange"
            item_3.image =
                "https://i.pinimg.com/originals/12/4e/52/124e5280ba9b02ed3db753542a5fe68c.png"
            item_4.name = "Guava"
            item_4.image =
                "https://www.acai.eu/acai/CustomUpload/374O357O340O370O356O369O350O320O322O320O328O/Guave-Pueree-FineFruitsClub-500x500px.gif"
            item_5.name = "Banana"
            ...
            item_7.name = "Apple"
            item_7.image =
                "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/images/sugar-comparing-apple-1534800501.png?crop=0.839xw:0.839xh;0.0777xw,0.159xh&resize=480:*"
            item_8.name = "Mango"
            ...
            item_10.name = "Meat"
            item_10.image =
                "https://5.imimg.com/data5/SELLER/Default/2020/10/QC/SH/YH/110830185/fresh-meat-250x250.png"
            item_11.name = "Fish"
            item_11.image =
                "https://cdn.shinjukuhalalfood.com/wp-content/uploads/2020/11/13041118/ayer-fish.png"
            item_12.name = "Cake"
            item_12.image =
                "https://cakeowls.com/wp-content/uploads/2020/04/IMG-20200102-WA0048.png"
